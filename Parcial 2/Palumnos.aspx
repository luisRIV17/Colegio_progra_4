<%@ Page Title="" Language="C#" MasterPageFile="~/Pmaster.Master" AutoEventWireup="true" CodeBehind="Palumnos.aspx.cs" Inherits="Parcial_2.Palumnos" %>
    ...
    <div class="container marg" style="width:70%">
        <div class="row justify-content-center ro">
            <div class="col-sm-12 col-md-3 col-lg-12  text-start">
                <asp:Label ID="Label2" Font-Size="1.9em" runat="server" Text="Ingreso de Alumnos" CssClass="titu"></asp:Label>
            </div>
        </div>
    </div>
    ...
    <div class="container cont">
        ...
        <div class="row justify-content-center ro">
            ...
            <div class="col-sm-12 col-md-6 col-lg-6 text-start  ">
                <asp:TextBox ID="txtcod" runat="server" CssClass="form-control tx "></asp:TextBox> 
            </div>
         </div>
         <div class="row justify-content-center ro">
             <div class="col-sm-12 col-md-3 col-lg-3 text-lg-end text-md-end text-sm-start">
        ...
        <div class="row justify-content-center ro">
             <div class="col-sm-12 col-md-3 col-lg-3 text-lg-end text-md-end text-sm-start">
                 <asp:Label ID="Label5" runat="server" Text="Fecha de Nacimiento:" CssClass="lb"></asp:Label>
             </div>
             <div class="col-sm-12 col-md-6 col-lg-6 text-start ">
                 <asp:TextBox ID="txtfecha"  runat="server" TextMode="DateTime" CssClass="form-control tx"></asp:TextBox>
             </div>
         </div>
        <div class="row justify-content-center ro">
            <div class="col-sm-12 col-md-3 col-lg-3 text-lg-end text-md-end text-sm-start">
        ...
        <div class="row justify-content-center ro">
            <div class="col-sm-12 col-md-3 col-lg-3 text-lg-end text-md-end text-sm-start">
                 <asp:Label ID="Label9" runat="server" Text="Correo:" CssClass="lb"></asp:Label>
             </div>
             <div class="col-sm-12 col-md-6 col-lg-6 text-start ">
                 <asp:TextBox ID="txtcorreo" runat="server" CssClass="form-control tx"></asp:TextBox>
             </div>
         </div>
        <div class="row justify-content-center ro">
            <div class="col-sm-12 col-md-3 col-lg-3 text-lg-end text-md-end text-sm-start">
        ...
        <div class="row justify-content-center ro">
             <div class="col-sm-12 col-md-12 col-lg-12 text-center">
                  ...
                  <asp:Button ID="Button2" runat="server"  OnClientClick="return confirm('Desea Editar este Alumno?')" Text="Editar" Enabled="False" CssClass="bt" OnClick="Button2_Click" />
                  <asp:Button ID="bteliminar" runat="server" Enabled="False"  OnClientClick="return confirm('Desea Eliminar este Alumno?')" Text="Eliminar" CssClass="bt" OnClick="bteliminar_Click" />
             </div>
             <div class="col-sm-12 col-md-12 col-lg-12 text-center">
